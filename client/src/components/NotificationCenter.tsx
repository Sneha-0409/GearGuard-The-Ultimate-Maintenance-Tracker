    ...
    <div className="relative" ref={containerRef}>
      ...
      <button 
        ...
        className={clsx(
          ...
          isOpen 
            ? "border-purple-300 bg-white/60 dark:bg-slate-800/60 dark:border-purple-500/50 text-purple-600 dark:text-purple-400 shadow-inner" 
            : "border-white/50 dark:border-slate-700 bg-white/30 dark:bg-slate-800/30 text-gray-600 dark:text-gray-300 shadow-sm dark:shadow-none hover:border-white/70 dark:hover:border-slate-600 hover:text-purple-600 dark:hover:text-purple-400 hover:bg-white/60 dark:hover:bg-slate-800/60"
        )}
      >
      ...
      {/* Notifications Panel */}
      {isOpen && (
        <div className="absolute right-0 mt-3 w-80 lg:w-96 glass dark:glass-dark rounded-2xl border border-white/60 dark:border-slate-700/50 bg-white/90 dark:bg-slate-800/90 shadow-2xl backdrop-blur-2xl animate-in fade-in slide-in-from-top-3 duration-300 overflow-hidden z-[60]">
          {/* Header */}
          <div className="flex items-center justify-between border-b border-gray-100 dark:border-slate-700/50 bg-gray-50/50 dark:bg-slate-800/50 p-4">
          ...
          <div className="max-h-[28rem] overflow-y-auto scrollbar-thin">
            {notifications.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12 px-4 transition-all">
                <div className="bg-gray-100 dark:bg-slate-700/50 rounded-full p-4 mb-3">
                  <Bell className="h-8 w-8 text-gray-400 dark:text-gray-500 opacity-50" />
                </div>
                <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">No alerts yet</p>
                <p className="text-xs text-gray-400 dark:text-gray-500">We'll notify you when things change.</p>
              </div>
            ) : (
                  ...
                  >
                    <div className="flex space-x-3">
                      ...
                      >
                        ...
                        <p className="mt-1 text-xs text-gray-400 dark:text-gray-500 font-medium whitespace-nowrap">
          ...
          <div className="border-t border-gray-100 dark:border-slate-700/50 bg-gray-50/50 dark:bg-slate-800/50 p-3 text-center">
            <Link 
              to="/settings" 
