...
var Badge = function (_a) {
    var children = _a.children, _b = _a.variant, variant = _b === void 0 ? 'default' : _b, _c = _a.size, size = _c === void 0 ? 'md' : _c, _d = _a.pulse, pulse = _d === void 0 ? false : _d, className = _a.className;
    var variants = {
    ...
    return (<span className={(0, clsx_1.default)('inline-flex items-center font-semibold rounded-full transition-all duration-300 backdrop-blur-sm', variants[variant], sizes[size], pulse && 'animate-pulse', className)}>
      {children}
    </span>);
};
